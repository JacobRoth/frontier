local carrierDefs = {
        ...
        {hostUnitDefID = UnitDefNames.lengineer.id, droneUnitDefID=UnitDefNames.kdroneminerflyer.id, reloadTime = 10, maxDrones = 6, spawnSize=2, managed=false, hostUnitID = nil, drones = {  }, reload = nil}
}
